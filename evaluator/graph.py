...
data = [
    ...
    "path": "/home/yusun/code/karan/data/generate/annotations/13B_Beam_annotations.json",
    "addition": "/home/yusun/code/karan/data/addition/annotations/13B_Beam_annotations.json",
    "color": 'blue'
    },
    {
    "name": "B16",
    "path": "/home/yusun/code/karan/data/generate/annotations/13B_b16_annotations.json",
    "addition": "/home/yusun/code/karan/data/addition/annotations/13B_b16_annotations.json",
    "color": 'orange'
    },
    {
    "name": "GPT 3.5",
    "path": "/home/yusun/code/karan/data/generate/annotations/13B_3.5_annotations.json",
    "addition": "/home/yusun/code/karan/data/addition/annotations/13B_3.5_annotations.json",
    "color": 'red'
    },
    {
    "name": "GPT 4",
    "path": "/home/yusun/code/karan/data/generate/annotations/13B_4_annotations.json",
    "addition": "/home/yusun/code/karan/data/addition/annotations/13B_4_annotations.json",
    'color': 'green'
    },   
]
...
def graph_overall_win_rate():
    ...
    plt.savefig('/home/yusun/code/karan/graphs/winrate.pdf')
    plt.clf()
...
def graph_degradation():    
    ...
    plt.legend()
    plt.savefig('/home/yusun/code/karan/graphs/degradation.pdf')    

def graph_addition():    
    for model in data:
        annotated = jload(model["addition"])
    ...
    plt.savefig('/home/yusun/code/karan/graphs/addition.pdf')    
